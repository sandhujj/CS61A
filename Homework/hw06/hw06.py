...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        if abs(self.year - Mint.present_year) - 50 > 0:
...
class VendingMachine:
    ...
    def vend(self):
        if self.stock == 0:
            ...
            bruv = self.funds - self.price
            self.funds = 0
            self.stock -=1
            return f'Here is your {self.type} and ${bruv} change.'
...
class AggressivePlayer(Player):
    ...
    Implement the choose method in the AggressivePlayer class, which returns the debate method if the player's popularity
    is less than or equal to other's popularity, and speech otherwise. Also implement the choose method in the CautiousPlayer class, 
